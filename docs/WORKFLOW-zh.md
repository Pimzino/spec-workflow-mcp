...
本指南解释了使用 Spec Workflow MCP 的完整规范驱动开发工作流程和最佳实践。
...
指导文档提供高层指导，保持项目的一致性和对齐。它们充当所有开发决策的北极星。
...
- 要描述性：`payment-processing` 而不是 `payments`
...
- [提示指南](PROMPTING-GUIDE.md) - 示例提示和模式
